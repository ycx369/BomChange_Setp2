<%@ Page Title="" Language="C#" MasterPageFile="~/Standard.Master" AutoEventWireup="true" CodeBehind="DeleHand1.aspx.cs" Inherits="BomChange.DeleHand1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <div class="row" style="text-align: left; margin-left: 10px; color: #38C859">
        <h3>所有删除物料<br />
            All Dele Material List</h3>
    </div>
