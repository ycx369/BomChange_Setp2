...
namespace BomChange
{
    public partial class AddHand1 : System.Web.UI.Page
    {
        ...
        private void Loaddata(string where)
        {
            ...
            "ALLLIST_ADDLIST.id,\n" +
            "ALLLIST_ADDLIST.`增加或减少`,\n" +
            "ALLLIST_ADDLIST.`柜号`,\n" +
            "ALLLIST_ADDLIST.`柜子描述`,\n" +
            "ALLLIST_ADDLIST.MO,\n" +
            "ALLLIST_ADDLIST.`物料号`,\n" +
            "ALLLIST_ADDLIST.`数量`,\n" +
            "ALLLIST_ADDLIST.`物料属性`,\n" +
            "ALLLIST_ADDLIST.`库位`,\n" +
            "ALLLIST_ADDLIST.`变更原因`,\n" +
            "ALLLIST_ADDLIST.`总数量`,\n" +
            "ALLLIST_ADDLIST.`MO下达车间`,\n" +
            "ALLLIST_ADDLIST.`变更影响`,\n" +
            "ALLLIST_ADDLIST.`物料描述`,\n" +
            "ALLLIST_ADDLIST.ECN,\n" +
            "ALLLIST_ADDLIST.SO,\n" +
            "ALLLIST_ADDLIST.`申请人`,\n" +
            "ALLLIST_ADDLIST.`申请日期`,\n" +
            "ALLLIST_ADDLIST.`批准人`,\n" +
            "ALLLIST_ADDLIST.`批准日期`,\n" +
            "ALLLIST_ADDLIST.`项目名称`,\n" +
            "ALLLIST_ADDLIST.`已处理`,\n" +
            "ALLLIST_ADDLIST.`处理人员`,\n" +
            "ALLLIST_ADDLIST.`完成时间`,\n" +
            "ALLLIST_ADDLIST.`收料人`,\n" +
            "ALLLIST_ADDLIST.`收料时间`\n" +
            "FROM\n" +
            "ALLLIST_ADDLIST\n" + where).Tables[0];
