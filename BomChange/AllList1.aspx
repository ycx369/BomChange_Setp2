<%@ Page Title="" Language="C#" MasterPageFile="~/Standard.Master" AutoEventWireup="true" CodeBehind="AllList1.aspx.cs" Inherits="BomChange.AllList1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <h3>所有MO物料清单（近三个月）<br />
             All MO Material List</h3>
    </div>
        <div  class="GridView" style="margin-left: 10px;overflow:auto" >
