...
<div class="col-lg-7">
    ...
    <div style="margin: 0 auto;text-align:center">
        <asp:GridView ID="GridView1" runat="server"  RowStyle-Wrap="false" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="20" CssClass="align-centent-center"    AlternatingRowStyle-Wrap="false" CellPadding="4" FooterStyle-Font-Size="XX-Large" ForeColor="#333333" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1" Width="134px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SEEEConnectionString %>" SelectCommand="SELECT [Product_Name], [p2] FROM [TEST2]"></asp:SqlDataSource>
    </div>
    <br />
