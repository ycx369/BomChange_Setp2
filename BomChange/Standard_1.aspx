<%@ Page Title="" Language="C#" MasterPageFile="~/Standard.Master" AutoEventWireup="true" CodeBehind="Standard_1.aspx.cs" Inherits="BomChange.Standard_1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridView" style="margin-left: 10px; margin-top: 10px; overflow: auto; text-align: center">
        <asp:GridView ID="GridView1" runat="server" RowStyle-Wrap="false" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="20" CssClass="align-centent-center" AlternatingRowStyle-Wrap="false" ForeColor="#333333" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" Font-Size="Medium" HeaderStyle-Font-Size="Large" FooterStyle-Font-Size="Large">
