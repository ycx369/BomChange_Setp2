                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (i > 0)
                        {
                            ...
                            Response.Cookies["user"].Expires = DateTime.Now.AddMinutes(120);
                            Response.Cookies["password"].Expires = DateTime.Now.AddMinutes(120);//设置Cookie过期时间
                            ...
                            Response.Redirect("Standard_1.aspx");
                        }
                        else
                        {
